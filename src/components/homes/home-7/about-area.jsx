...
const about_content = {
  ...
  title: (
    <>
      about <br /> maidaan group
    </>
  ),
  about_P_title: <>About Maidaan Group.</>,
  des: (
    <>
      Maidaan Group is a dynamic and forward-thinking conglomerate with a
      diverse portfolio of projects that span across real estate, construction,
      and community development. With a strong commitment to excellence,
      innovation, and sustainability, we have positioned ourselves as leaders in
      the industries we operate in. At Maidaan Group, we take pride in our
      ability to create impactful solutions that not only meet the market's
      demands but also enhance the lives of individuals and communities around
      the world.
      <br />
      <br />
      Our projects are a reflection of our core values: quality, transparency,
      and client-centricity. Whether it's through our state-of-the-art
      residential communities like Grand Prairie Gardens (GPG), or through our
      cutting-edge marketing and event services for the real estate industry
      through Maidaan Marketing, our focus is always on delivering excellence
      with a strong sense of purpose.
      <br />
      <br />
      Maidaan Group is a diverse family of businesses united by a common goal:
      to build communities, foster collaboration, and create opportunities for
              ...
              <div className="law-about-left p-relative mb-30">
                <div className="row gx-4">
                  <div className="col-md-6">
                    <div
                      className={`law-about-left-title mt-60 mb-20 ${
                        style_about ? "vogue-bg" : "wine-bg"
                      } `}>
                      <span>
                  ...
                  <div className="tp-section">
                    <h2
                      className={`tp-section__title ${
                        style_about
                          ? "wow tpfadeUp mb-30"
                          : "wine-text-color mb-20 text-uppercase"
                      }`}>
                      {style_about ? about_P_title : title}
                    </h2>
                    <p className="text-grey">{des}</p>
                  </div>
                </div>
